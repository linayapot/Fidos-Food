...
async function petinfo_form_callback({ request, params }) {
  ...
  return redirect(`/P3YourFoodInfo`);
}
...
function P2YourPetInfo() {
  return (
    <div className="App">
      <img src={logo} className="App-logo"  alt="doglogo" />
      <div className="first-header">
       
        Enter Your Dog's Information </div>
      ...
      <ul class="flex-outer">
        ...
        <li>
          ...
          <ul class="flex-inner">
          <li>
            {/*<label required htmlFor="SN">Spay/Neuter:</label>*/}
...
export {petinfo_form_callback, P2YourPetInfo};